...
public class TabelaAssociados extends javax.swing.JFrame {
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        DefaultTableModel modelo = (DefaultTableModel) jAssociado.getModel();
        if (jAssociado.getSelectedRow() != -1) {
            String CPF =  modelo.getValueAt(jAssociado.getSelectedRow(), 0).toString();
            CadastroEmpregado t = new CadastroEmpregado();
            t.setNovo(false);
            t.setEmpregado(bd.localiza(CPF));
            t.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Nenhum Associado foi selecionado");
